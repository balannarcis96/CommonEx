...
/*------------------------------------------------------------
	SMathSSE.h
		Math functions enchanced using SSE
  ------------------------------------------------------------*/
...
*/
inline VectorRegister MakeVectorRegister(ULONG X, ULONG Y, ULONG Z, ULONG W)
{
...
*/
inline VectorRegister VectorLoadFloat3_W1(const void* Ptr)
{
